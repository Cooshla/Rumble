...
namespace BlankXamarinApp.iOS
{
    ...
    public partial class AppDelegate : XFormsApplicationDelegate
    {
        ...
        {
            const string dbName = "BlankXamarinApp.db3"; 
		...
		private void CopyFileInBundleToDocumentsFolder(String filename)
		{
			...
			try {
				...
				{
					Stream str = Assembly.GetExecutingAssembly().GetManifestResourceStream(@"BlankXamarinApp.iPhone.Assets.BlankXamarinApp.db3");
